...
// =============================================================================================
/**
 *  The DigOnDelay class implements digital on delay logic, used by sequential boolean logic
 *  where the output is held false for a period of time after the input goes true. <br>     
 *<br>
 *  File:   DigOnDelay.java<br>
 *<br>
