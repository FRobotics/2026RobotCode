...
// =============================================================================================
/**
 *  The DigOneShot class implements digital one shote logic, used by sequential boolean logic
 *  where the output is pulsed for a specific period of time when the input transitions from
 *  false to true. <br>     
 *<br>
 *  File:   DigOneShot.java<br>
 *<br>
